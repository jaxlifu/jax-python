...
class SpiderCore:
    def __init__(self):
        ...
        self.mysql_password = ''
        self.mysql_database = 'spider_user'
    ...
    def start_spider_core(self):
        ...
        try:
            ...
            # 创建MySQL连接
            print(self.mysql_host, self.mysql_username,
            ...
            #     charset='utf8'
            # )
            self.mysql_connection = MySQLdb.connect(host=self.mysql_host,
    ...
    def load_config(self):
        ...
        self.download_thread_num = int(
            config.get(section, 'downloadThreadNum'))
        self.network_retry_times = int(
            config.get(section, 'networkRetryTimes'))
